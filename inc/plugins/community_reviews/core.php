        ...
        if (!self::$urlPatterns) {
            if (self::settings('seo_urls') && self::$forceUrlFormat != 'raw') {
                self::$urlPatterns = [
                    ...
                    'add_comment_reply' => '/reviews-product-%d-%s?add_comment=1&reply=%d',
                ...
                self::$urlPatterns = [
                    ...
                    'add_comment_reply' => '/index.php?action=reviews&product=%d&add_comment=1&reply=%d',
                    'edit_comment' => '/index.php?action=reviews&product=%d&edit_comment=%d',
                    'delete_comment' => '/index.php?action=reviews&product=%d&delete_comment=%d',
